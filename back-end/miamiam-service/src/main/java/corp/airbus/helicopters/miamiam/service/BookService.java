...
import corp.airbus.helicopters.miamiam.adapter.BookAdapter;
...
import corp.airbus.helicopters.miamiam.model.MediaDTO;
...
public class BookService extends AbstractService<BookDTO> {
	 ...
	 * 
	 * @see
	 * com.sqli.commons.core.service.AbstractService
	 * #all()
	 */
	@Override
